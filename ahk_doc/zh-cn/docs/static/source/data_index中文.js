...
index = [
  ...
  ["绝对值, abs()","Functions.htm#Abs"],
  ["致谢","misc/Acknowledgements.htm"],
  ["ACos()","Functions.htm#ACos"],
  ["激活窗口","commands/WinActivate.htm"],
  ["ActiveX 控件 (GUI)","commands/GuiControls.htm#ActiveX"],
  ["add","commands/EnvAdd.htm"],
  ["Address of a variable","Variables.htm#amp"],
  ["变量地址","Variables.htm#amp"],
  ["管理员权限运行脚本","Variables.htm#RequireAdmin"],
  ...
  ["关闭窗口","commands/WinClose.htm"],
  ["CLSID 列表 (我的电脑, 等.)","misc/CLSID-List.htm"],
  ["color names, RGB/HTML","commands/Progress.htm#colors"],
  ["颜色名称, RGB/HTML","commands/Progress.htm#colors"],
  ["color of pixels","commands/PixelSearch.htm"],
  ["像素颜色","commands/PixelSearch.htm"],
  ["COM","commands/ComObjCreate.htm"],
  ["ComboBox 控件 (GUI)","commands/GuiControls.htm#ComboBox"],
  ["comma operator (multi-statement)","Variables.htm#comma"],
  ["逗号操作 (多重声明)","Variables.htm#comma"],
  ["命令行参数","Scripts.htm#cmd"],
  ["命令列表(按字母排序),"commands/index.htm"],
  ["CommentFlag","commands/_CommentFlag.htm"],
  ["注释标志","commands/_CommentFlag.htm"],
  ["comments in scripts","Scripts.htm#Comments"],
  ["脚本注释","Scripts.htm#Comments"],
  ...
  ["编译脚本","Scripts.htm#ahk2exe"],
  ["ComSpec","Variables.htm#ComSpec"],
  ["表达式中的连接符","Variables.htm#concat"],
  ["脚本续行","Scripts.htm#continuation"],
  ["context menu (GUI)","commands/Gui.htm#GuiContextMenu"],
  ["上下文菜单 (GUI)","commands/Gui.htm#GuiContextMenu"],
  ["延续片段","Scripts.htm#continuation"],
